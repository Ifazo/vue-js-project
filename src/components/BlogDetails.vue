<template>
  <div>
    ...
    <div class="max-w-3xl px-4 pt-6 lg:pt-10 pb-12 sm:px-6 lg:px-8 mx-auto">
      <div class="max-w-2xl">
                      ...
                      <div
                        ...
                        <div class="p-4 sm:p-5">
                          ...
                          <p class="text-sm text-gray-400">
                            ...
                            and spends her time speaking to in-house recruiters
                            all over the world.
                          </p>
                        </div>
                        <!-- End Body -->
        ...
        <div class="space-y-5 md:space-y-8">
          ...
          <div>
            <a
              class="m-1 inline-flex items-center gap-1.5 py-2 px-3 rounded-full text-sm bg-gray-100 text-gray-800 hover:bg-gray-200 dark:bg-gray-800 dark:hover:bg-gray-700 dark:text-gray-200 dark:focus:outline-none dark:focus:ring-1 dark:focus:ring-gray-600"
              href="#">
              Plan
            </a>
            <a
    ...
    <div class="sticky bottom-6 inset-x-0 text-center">
      <div
        class="inline-block bg-white shadow-md rounded-full py-3 px-4 dark:bg-gray-800">
        <div class="flex items-center gap-x-1.5">
          ...
          <div
            class="block h-3 border-e border-gray-300 mx-3 dark:border-gray-600"></div>
