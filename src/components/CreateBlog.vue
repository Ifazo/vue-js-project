<template>
  <div>
    <div class="font-sans text-base text-gray-900 sm:px-10">
      ...
      <div
        class="mx-auto mb-20 flex w-full max-w-screen-lg flex-col overflow-hidden rounded-xl text-gray-900 md:flex-row md:border md:shadow-lg">
        <form
        ...
        <div
          ...
          <div class="">
            ...
            <hr
              class="my-2 h-0 border-t border-r-0 border-b-0 border-l-0 border-gray-300" />
